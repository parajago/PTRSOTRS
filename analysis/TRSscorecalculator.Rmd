...
ggforest(fit.coxphall, data = PFS_European, main="Predicted transcriptomic score from all patients\n subtype as covariate/interaction, progression-free survival, EUR ancestry")
```
