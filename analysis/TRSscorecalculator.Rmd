...
```{r PRS score generation, cache=TRUE, warning=FALSE}
...
```{r Cox regression of PRS on overall survival, cache=TRUE, warning=FALSE}
...
```{r Cox regression of PRS on recurrence, cache=TRUE, warning=FALSE}
...
#Risk variants: Predicted transcriptomic score
...
```{r Predicted-TPRS score generation for overall survival, cache=TRUE, warning=FALSE}
...
```{r Cox regression of Predicted TRS and overall survival, cache=TRUE, warning=FALSE}
...
```{r Predicted-TPRS score generation for progression-free survival, cache=TRUE, warning=FALSE}
...
```{r Cox regression of Predicted TRS and recurrence, cache=TRUE, warning=FALSE}
...
#Risk variants: Observed transcriptomic score
...
```{r Observed-TPRS score generation, cache=TRUE, warning=FALSE}
...
```{r Cox regression of Observed TRS and overall survival, cache=TRUE, warning=FALSE}
...
```{r Observed-TPRS score generation for progression free survival, cache=TRUE, warning=FALSE}
pheno <- famPFS %>% select(fullID,phenotype)
names(pheno) = c("SUBJID", "phenotype") 
...
```{r Cox regression of Observed TRS and progression-free survival, cache=TRUE, warning=FALSE}
...
#Survival variants: Predicted transcriptomic score
...
```{r Survival-weighted Predicted-TPRS score generation for overall survival, cache=TRUE,  warning=FALSE}
...
```{r Survival-weighted Cox regression of Predicted TRS and overall survival, cache=TRUE, warning=FALSE}
...
```{r Survival-weighted Predicted-TPRS score generation for progression-free survival, cache=TRUE, warning=FALSE}
...
```{r Survival-weighted Cox regression of Predicted TRS and recurrence, cache=TRUE, warning=FALSE}
...
#Survival variants: Observed transcriptomic score
...
```{r Survival-weighted Observed-TPRS score generation, cache=TRUE, warning=FALSE}
...
```{r Survival-weighted Cox regression of Observed TRS and overall survival, cache=TRUE, warning=FALSE}
...
```{r Survival-weighted Observed-TPRS score generation for progression free survival, cache=TRUE, warning=FALSE}
pheno <- famPFS %>% select(fullID,phenotype)
names(pheno) = c("SUBJID", "phenotype") 
...
```{r Survival-weighted Cox regression of Observed TRS and progression-free survival, cache=TRUE, warning=FALSE}
...
#Subtype-specific variants: LumA/ Predicted
```{r LumA-specific Predicted-TPRS score generation for overall survival, cache=TRUE, warning=FALSE}
...
```{r LumA-specific Cox regression of Predicted TRS and overall survival, cache=TRUE, warning=FALSE}
...
#Subtype-specific variants: LumB/ Predicted
```{r LumB-specific Predicted-TPRS score generation for overall survival, cache=TRUE,  warning=FALSE}
...
```{r LumB-specific Cox regression of Predicted TRS and overall survival, cache=TRUE, warning=FALSE}
...
#Subtype-specific variants: TNBC/ Predicted
```{r TNBC-specific Predicted-TPRS score generation for overall survival, cache=TRUE, warning=FALSE}
...
```{r TNBC-specific Cox regression of Predicted TRS and overall survival, cache=TRUE, warning=FALSE}
...
#Subtype-specific variants: HER2/ Predicted
```{r HER2-specific Predicted-TPRS score generation for overall survival, cache=TRUE, warning=FALSE}
...
```{r HER2-specific Cox regression of Predicted TRS and overall survival, cache=TRUE, warning=FALSE}
...
#Combined subtype-specific contribution
```{r Subtype-specific Cox regression of Predicted TRS and overall survival, cache=TRUE, warning=FALSE}
...
```{r Cox regression of combined methods and overall survival, cache=TRUE, warning=FALSE}
...
```{r Cox regression of combined methods and progression-free survival, cache=TRUE, warning=FALSE}
